...
if (rex_get('write', 'int', 0)) {
    ...
    foreach ($modules as $module) {
        rex_file::put(rex_path::addon("search_it", "module/".$module['key'].".json"), json_encode($module));
    }
    ...
    foreach ($templates as $template) {
        rex_file::put(rex_path::addon("search_it", "template/".$template['key'].".json"), json_encode($template));
    }
}
